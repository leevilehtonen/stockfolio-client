            ...
            <div>
                <Form onSubmit={this.handleSubmit} className="register-form">
                    ...
                    <FormGroup color={(!this.state.emailValid && this.state.emailTouched) ? "danger" : ""} className="text-white">
                        ...
                        <Input type="text" value={this.state.email} onChange={this.handleChange} onBlur={this.handleBlur("email")} name="email" id="emailInput" className="text-white" placeholder="Enter email" />
                    ...
                    <FormGroup color={(!this.state.nameValid && this.state.nameTouched) ? "danger" : ""} className="text-white">
                        ...
                        <Input type="text" value={this.state.name} onChange={this.handleChange} onBlur={this.handleBlur("name")} name="name" id="nameInput" className="text-white" placeholder="Enter name" />
                    ...
                    <FormGroup color={((!this.state.passwordValid && this.state.passwordTouched) || (!this.state.passMatch && this.state.passwordRepeatTouched)) ? "danger" : ""} className="text-white">
                        ...
                        <Input type="password" value={this.state.passwordRepeat} onChange={this.handleChange} onBlur={this.handleBlur("passwordRepeat")} name="passwordRepeat" id="passwordRepeatInput" className="text-white mt-4" placeholder="Repeat password" />
